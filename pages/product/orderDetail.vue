<template>
	<view class="content">
		<view class="row b-b b-t" v-if="status._deliveryType == '快递配送'" @click="towuliu(item)">
			<text class="order-status" v-if="status._title == '待评价'">已完成</text>
			<text class="order-status" v-else-if="status._title == '申请退款中'">{{status._msg}}</text>
			<text class="order-status" v-else>{{ status ? status._msg : '' }}（查看物流）</text>
		</view>
		<view class="row b-b b-t" v-else>
			<text class="order-status" v-if="status._title == '待评价'">已完成</text>
			<text class="order-status" v-else-if="status._title == '申请退款中'">{{status._msg}}</text>
			<text class="order-status" v-else>{{ status ? status._msg : '' }}</text>
		</view>
				...
				<view class="right position-relative">
					<view class="flex">
						...
						<view class="title-right">
							...
							<view class="attr-box">{{ goodsItem.attrInfo ? goodsItem.attrInfo.suk : '' }} x {{ goodsItem.cart_num + '' + goodsItem.productInfo.unit_name }}</view>
						</view>
					</view>
				</view>
			</view>
		...
		<view class="orderDetialBox">
			...
			<view class="item flex">
				<view class="title-left flex">
					...
					<view class="text" v-if="status._title == '待评价'">已完成</view>
					<!-- <view class="text" v-else-if="status._title == '申请退款中'">{{status._title}}</view> -->
					<view class="text" v-else>{{ status._title }}</view>
				</view>
			</view>
			<view class="item flex">
				<view class="title-left flex">
					<text class="title">支付方式:</text>
					<view class="text">{{ status._payType }}</view>
				</view>
			</view>
		</view>
		...
		<view class="orderDetialBox" v-if="item.delivery_id">
			...
			<view class="item flex">
				...
				<view v-if="status._deliveryType == '快递配送'" class="buttom-right" @click="towuliu(item)">查看物流</view>
			</view>
			<view class="item flex">
				<view class="title-left flex">
